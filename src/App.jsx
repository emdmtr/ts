          ...
          <div className="cards-fan">
            <div className="help-card card-1">
              <div className="card-content">
                ...
                <p>
                  Короткі та зрозумілі матеріали від фахівців про тривогу,
                  стрес, самооцінку та стосунки.
                </p>
            ...
            <div className="help-card card-4">
              <div className="card-content">
                <h3>🤫 Анонімний чат</h3>
                <p>
                  Безпечне місце, де можна написати про все, що турбує. Без
                  страху, що хтось дізнається.
                </p>
                <p>
                  Спілкування з консультантом або волонтером у реальному часі.
                </p>
              </div>
              <div className="card-footer">
        ...
        <section className="info-section">
          <div className="info-container">
            <div className="info-text">
              ...
              <p>
                Можна поговорити в <a href="#">анонімному чаті</a>, отримати
                поради від психологів або <br />
                спробувати прості вправи на релакс та підняття настрою. Кожен
                крок <br />
